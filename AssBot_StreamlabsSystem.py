...
#---------------------------
ScriptName = "AssBot"
Website = "https://www.github.com/assaaassin"
Description = "!assaaass1n will post a message in chat but works without it as well"
Creator = "assaaass1n"
Version = "1.0.0.0"
...
def Init():
    ...
    all_responses = ["git gud pleb", "when is your bday bo", "KEKW", "LUL LUL LUL", 
                    "Kappa", "mrboja1W mrboja1W mrboja1W mrboja1W", 
...
def Tick():
    if (TickCount % 10000) != 0:
        Parent.SendStreamMessage(my_response)
    return
